...
Aktuelle Version: `v0.1.0-beta.7`
...
den [Versionshinweisen](releases/0.1.0-beta.7.md) und technische Arbeitspunkte
...
- [Versionshinweise](releases/0.1.0-beta.7.md): Inhalt des aktuellen Tags.
