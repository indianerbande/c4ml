...
Aktuelle Version: `v0.1.0-beta.8`
...
den [Versionshinweisen](releases/0.1.0-beta.8.md) und technische Arbeitspunkte
...
- [Versionshinweise](releases/0.1.0-beta.8.md): Inhalt des aktuellen Tags.
