...
[English](0.1.0-beta.1.md) | [Deutsch](../../de/releases/0.1.0-beta.1.md)
...
is presented as a public release download. The [project status](../project-status.md) explains the
