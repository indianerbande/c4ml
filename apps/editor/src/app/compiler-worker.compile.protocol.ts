...
export interface CompilerWorkerNarrativeResource {
  readonly uri: string;
  readonly source: string;
}
...
export interface CompilerWorkerThemeResource {
  readonly uri: string;
  readonly source: string;
}
...
export function isCompilerWorkerProject(
  ...
  return (
    ...
    (candidate.narratives === undefined ||
      (Array.isArray(candidate.narratives) &&
        candidate.narratives.every((resource) =>
          typeof resource === "object" && resource !== null &&
          typeof (resource as Partial<CompilerWorkerNarrativeResource>).uri === "string" &&
          (resource as Partial<CompilerWorkerNarrativeResource>).uri!.length > 0 &&
    ...
    (candidate.theme === undefined ||
      (typeof candidate.theme === "object" && candidate.theme !== null &&
        typeof (candidate.theme as Partial<CompilerWorkerThemeResource>).uri === "string" &&
        (candidate.theme as Partial<CompilerWorkerThemeResource>).uri!.length > 0 &&
        typeof (candidate.theme as Partial<CompilerWorkerThemeResource>).source === "string" &&
        (candidate.theme as Partial<CompilerWorkerThemeResource>).source!.length > 0)) &&
    (candidate.shapes === undefined ||
      (typeof candidate.shapes === "object" && candidate.shapes !== null &&
        typeof (candidate.shapes as Partial<CompilerWorkerShapeResource>).uri === "string" &&
