...
- [ ] add a read-only inspector that explains automatic candidate geometry,
  applied placement intent, adjustments, pins, Ports, and route guidance;
- [ ] navigate every explanation to its owning source range; and
- [ ] distinguish guaranteed hard intent, relaxed soft intent, and automatic
  engine choices.

### Slice 1.2 — graphical placement edits
...
### Slice 1.3 — graphical route edits
...
### Slice 1.4 — semantic graphical authoring
